...
try {
    ...
    foreach ($stmt->fetchAll() as $dados => $linha) {
        ...
        echo "<tr>";
        echo "<td>". $linha['idproduct'] . "</td>";
        echo "<td>". $linha['ISBN'] . "</td>";
        echo "<td>". $linha['title'] . "</td>";
        echo "<td>". $linha['author'] . "</td>";
        echo "<td>". $linha['publisher'] . "</td>";
        echo "<td>". $linha['pdate'] . "</td>";
        echo "<td>". $linha['price'] . "</td>";
        echo "<td>". $linha['genre'] . "</td>";
        echo "<td>". $linha['tags'] . "</td>";

        echo "<td> 
                <form action='remove.php' method='post'>
                <input type='hidden' id='id' name='id' value='". $linha['idproduct'] . "'/>
